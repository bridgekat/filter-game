...
/--
The conversion `Filter.as_basis` preserves membership relations. This lemma says
that the conversion is indeed direct enough.
-/
...
/--
We will be using "set-builder notations" to define the reverse construction.
